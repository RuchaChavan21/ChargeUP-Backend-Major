package chargeUp.dev.core.aspect.performance;

import chargeUp.dev.entity.domain.dao.MethodExecutionTime;
import chargeUp.dev.service.methodexecutiontime.MethodExecutionTimeService;
...
public class PerformanceAspect {
     ...
     */
    @Around("execution(* chargeUp.dev.controller.*Controller.*(..))")
     ...
     * @throws Throwable if any error occurs during method execution.
     */
    @Around("execution(* chargeUp..dev.core..*.*(..))")
     ...
     * @throws Throwable if any error occurs during method execution.
     */
    @Around("execution(* chargeUp.dev.service..*.*(..))")
